...
// The main logic is copied from Dragonboat.
...
// Castagnoli has better error detection characteristics than IEEE and faster.
...
//	v := Checksum(buf[:requestHeaderSize])
...
//	binary.BigEndian.PutUint32(buf[10:], 0)
//	expected := Checksum(buf[:requestHeaderSize])
