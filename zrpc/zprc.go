...
// Package zrpc contains structs, interfaces and function definitions required
// to build customized Zai RPC modules.
//
// Structs, interfaces and functions defined in the zrpc package are only
...
//
// Structs, interfaces and functions defined in the zrpc package are not
...
import (
	...
	colf "github.com/zaibyte/pkg/zcolf"
)

type ObjPutHandler func(req colf.PutObjReq) colf.PutObjResp

type ObjGetHandler func(req colf.GetObjReq) colf.GetObjResp

type ObjDelHandler func(req colf.DelObjReq) colf.DelObjResp
